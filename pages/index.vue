<template lang="pug">
  .p-20.pt-40
    ...
    pdf2img(:data="aCankaoxiaoxi" name="cankao" :scale="1.8" :gap="30" type="img" v-if="aCankaoxiaoxi.length")
    .h-920.bg-text(v-else)

    h2.mb-10 环球时报

    pdf2img(:data="aHuanqiushibao" name="huanqiu" :scale="1.8" :gap="30" type="img" v-if="aHuanqiushibao.length")
    .h-920.bg-text(v-else)
